...
parser = argparse.ArgumentParser(description='Deflate64 ' +
                                 'Decoding Base 64 strings,' +
                                 'decompress content')
group = parser.add_mutually_exclusive_group()
group.add_argument("-b", "--base64", action="store",
                   dest="b",
                   help="string in Base64 format")
group.add_argument("-u", "--uncompress", action="store",
                   dest="u",
                   help="compress string in Base64 format")
parser.add_argument("--txt",  dest="txt", action="store",
